...
import hawkshop_top01.service.NhanVienService;

/**
 *
 * @author MSI
 */
public class NhanVien_Dialog extends javax.swing.JFrame {
    /**
     * Creates new form NhanVien_Dialog
     */
    public NhanVien_Dialog() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanVien_Dialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhanVien_Dialog().setVisible(true);
            }
        });
    }
